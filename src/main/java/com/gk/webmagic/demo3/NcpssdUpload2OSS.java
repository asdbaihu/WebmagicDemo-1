...
public class NcpssdUpload2OSS {

	private Logger logger = LoggerFactory.getLogger(getClass());

	private static final String directory = "F:/ncpssd";
	private static final String uploadDirectory = "ncpssd";
	...
	public static void main(String[] args) {
		NcpssdUpload2OSS ncpssdUpload2OSS = new NcpssdUpload2OSS();
		ncpssdUpload2OSS.uploadMonitor();
		ncpssdUpload2OSS.batchUpload(ncpssdUpload2OSS.getOssClient(), directory, uploadDirectory);
		ncpssdUpload2OSS.setStopFlag(true);// 上传文件停止
	}
